...
TESTS = [
    ...
    ("draw_ellipse",        dict(cx=3500, cy=500, semi_major=400, semi_minor=200, rotation_deg=0)),
    ...
    ("draw_dimension_linear", dict(x1=0, y1=-200, x2=1000, y2=-200,
                                    text_x=500, text_y=-400)),
    # ── layers ───────────────────────────────────────────────────────────────
    ("create_layer",        dict(name="TEST-LAYER", color="red")),
    ("set_current_layer",   dict(name="TEST-LAYER")),
    ("list_layers",         dict()),
    ...
    ("create_block",        dict(name="TEST_BLK", base_x=0, base_y=0)),
    # ── arrays ───────────────────────────────────────────────────────────────
    ...
    ("draw_door",           dict(x=500, y=1000, width=900, rotation_deg=0, swing="left")),
    ("draw_window",         dict(x=1500, y=1000, width=1200, thickness=150)),
    ("draw_opening",        dict(x=2200, y=1000, width=800, thickness=150)),
    ("draw_room",           dict(x=3500, y=1000, width=3000, depth=2000,
                                  name="LIVING", layer="A-WALL")),
    ("draw_stair",          dict(x=7000, y=1000, width=1200, num_treads=12,
                                  tread_depth=250)),
    ("label_room",          dict(x=4000, y=2000, room_name="LIVING ROOM",
    ...
    # ── schedules ─────────────────────────────────────────────────────────────
    ("generate_room_schedule",   dict(x=0, y=-1000,
                                       rooms=[{"name":"Living","width":4000,"depth":5000,
                                               "floor":"Oak","wall":"White","ceiling":"White"}])),
    ("generate_door_schedule",   dict(x=3000, y=-1000,
                                       doors=[{"mark":"D1","width":900,"height":2100,
                                               "type":"Solid","material":"Timber"}])),
    ("generate_window_schedule", dict(x=6000, y=-1000,
                                       windows=[{"mark":"W1","width":1200,"height":1050,
                                                 "type":"Casement","material":"uPVC"}])),
    ("generate_ffe_schedule",    dict(x=0, y=-3000,
                                       items=[{"mark":"F01","name":"Sofa","qty":1,
                                               "supplier":"TBD","code":"S001","finish":"Fabric"}])),
    ("generate_material_finish_schedule", dict(x=4000, y=-3000,
                                                materials=[{"name":"Oak Floor",
                                                            "hatch_pattern":"ANSI31",
                                                            "hatch_scale":1.0,
                                                            "description":"Engineered oak",
                                                            "supplier":"TBD","code":"F01"}])),
    ("generate_revision_table",  dict(x=8000, y=-3000)),
    # ── id_annotations ───────────────────────────────────────────────────────
    ("draw_elevation_marker",    dict(x=0,    y=-5000, label="A")),
    ("draw_section_cut",         dict(x1=0,   y1=-5500, x2=2000, y2=-5500, label="1")),
    ("draw_north_arrow",         dict(x=3000, y=-5000, radius=200)),
    ("draw_scale_bar",           dict(x=4000, y=-5000, scale=100, num_divisions=5)),
    ("draw_revision_cloud",      dict(x1=5000,y1=-5200,x2=6000,y2=-4800)),
    ("draw_material_callout",    dict(x=7000, y=-5000, material_name="OAK FLOOR",
                                       finish="Matt lacquer")),
    ("draw_detail_bubble",       dict(x=8500, y=-5000, detail_num="1", sheet_ref="A301")),
    ("draw_grid_line",           dict(x1=0, y1=-6000, x2=0, y2=-4000, label="A",
                                       bubble_radius=150)),
    ("draw_room_tag",            dict(x=1500, y=-5500, room_name="BEDROOM",
    ...
    ("draw_l_shaped_room",       dict(x=0, y=-9000,
                                       ...
                                       wall_thickness=150)),
    ("draw_ceiling_plan",        dict(x=0, y=-14000, width=4000, depth=3000)),
    ("draw_wall_elevation",      dict(x=5000, y=-9000,
                                       width=4000, height=2700,
                                       wall_label="ELEVATION A")),
    ("draw_skirting_board",      dict(x1=0, y1=-15000, x2=4000, y2=-15000, height=100)),
    ("draw_cornice",             dict(x1=0, y1=-15200, x2=4000, y2=-15200, depth=80)),
    ("draw_dado_rail",           dict(x1=0, y1=-15400, x2=4000, y2=-15400)),
    ("draw_window_elevation",    dict(x=5000, y=-14000,
                                       width=1200, height=1050,
                                       window_type="casement")),
    ("draw_staircase_symbol",    dict(x=0, y=-17000, width=1200, num_treads=14,
                                       tread_depth=250, direction="up")),
    ...
    ("draw_isometric_grid",      dict(origin_x=3000, origin_y=-23000,
                                       grid_size=500, num_lines=6)),
    ("draw_orthographic_views",  dict(origin_x=0, origin_y=-25000,
                                       width=2000, height=1500, depth=1000)),
    ("draw_section_hatch",       dict(x1=4000, y1=-25000, x2=6000, y2=-23000,
                                       pattern="ANSI31")),
    ("draw_scale_comparison",    dict(x=7000, y=-23000,
                                       reference_length=1000,
                                       scales=[50, 100, 200])),
    ("draw_golden_ratio_rectangle", dict(x=0, y=-28000, width=1618)),
    ("draw_perspective_grid_1pt", dict(origin_x=3000, origin_y=-28000,
                                        vp_x=3000, horizon_y=-26500,
                                        ground_y=-29000)),
    ("draw_perspective_grid_2pt", dict(origin_x=6000, origin_y=-28000,
                                        horizon_y=-26500, ground_y=-29000)),
    ("draw_surface_development",  dict(x=0, y=-32000, shape="prism",
                                        width=500, height=1000, depth=300)),
    ("draw_surface_development",  dict(x=2000, y=-32000, shape="pyramid",
                                        width=500, height=1000, depth=300)),
    ("draw_material_hatch_samples", dict(x=4000, y=-32000)),
    # ── anthropometry ─────────────────────────────────────────────────────────
    ...
    ("draw_ergonomic_clearances", dict(cx=2500, cy=-35000, furniture_type="desk")),
    ("draw_wheelchair_turning",  dict(cx=4000, cy=-35000)),
    ("draw_corridor_clearances", dict(x=5000, y=-35000, width=1200, length=3000,
                                       corridor_type="standard")),
    ("check_space_compliance",   dict(x=7000, y=-35000,
                                       room_width=3000, room_depth=3000,
                                       room_type="bedroom")),
    ("draw_kitchen_work_triangle", dict(sink_x=0,    sink_y=-38000,
                                         hob_x=1200,  hob_y=-38000,
                                         fridge_x=600, fridge_y=-39200)),
    ("draw_reach_zones",         dict(x=3000, y=-38000, posture="standing")),
    ("draw_ergonomic_dimensions_table", dict(x=5000, y=-36000, category="seating")),
    ("draw_anthropometry_overlay", dict(x=8000, y=-38000,
                                         width=3000, depth=3000)),
    # ── mep_services ─────────────────────────────────────────────────────────
    ("place_power_outlet_symbol", dict(x=0, y=-42000)),
    ("place_light_switch",        dict(x=500, y=-42000)),
    ("draw_circuit_run",          dict(circuit_id="C1", circuit_type="lighting",
                                        points=[(0,-43000),(2000,-43000),(2000,-42000)])),
    ("draw_distribution_panel",   dict(x=3000, y=-43000,
                                        circuits=[{"id":"C1","type":"lighting","load":"100W"},
                                                  {"id":"C2","type":"power","load":"2kW"}])),
    ("place_lighting_symbol",     dict(x=5000, y=-42000, light_type="downlight")),
    ("place_lighting_symbol",     dict(x=5800, y=-42000, light_type="strip")),
    ("place_plumbing_symbol",     dict(x=7000, y=-42000, symbol_type="wc")),
    ...
    ("draw_wet_room_plumbing",    dict(origin_x=4000, origin_y=-47000,
                                        room_width=2400, room_depth=2000)),
    ("place_ac_unit",             dict(x=0, y=-49000, unit_type="split")),
    ("place_diffuser",            dict(x=1500, y=-49000, diffuser_type="square")),
    ("draw_ductwork",             dict(points=[(3000,-49000),(5000,-49000)],
                                        width=400, height=250)),
    ("place_safety_symbol",       dict(x=6000, y=-49000, symbol_type="smoke_detector")),
    ("draw_services_legend",      dict(x=8000, y=-48000)),
    # ── tile_design ──────────────────────────────────────────────────────────
    ("draw_tile_grid",            dict(room_x=0,  room_y=-53000,
                                        room_w=3000, room_h=3000,
                                        tile_w=600,  tile_h=600)),
    ("draw_running_bond",         dict(room_x=4000, room_y=-53000,
                                        room_w=3000,  room_h=3000,
                                        tile_w=600,   tile_h=300)),
    ("draw_herringbone",          dict(room_x=8000, room_y=-53000,
                                        room_w=3000,  room_h=3000,
                                        tile_size=600)),
    ("draw_chevron",              dict(room_x=0, room_y=-57000,
                                        room_w=3000, room_h=3000, tile_w=600, tile_h=300)),
    ("draw_basket_weave",         dict(room_x=4000, room_y=-57000,
                                        room_w=3000, room_h=3000, tile_size=300)),
    ("draw_versailles_pattern",   dict(room_x=8000, room_y=-57000,
                                        room_w=3000, room_h=3000)),
    ("draw_diagonal_grid",        dict(room_x=0, room_y=-61000,
                                        room_w=3000, room_h=3000, tile_size=600)),
    ("calculate_tile_waste",      dict(room_w=4000, room_h=3000,
                                        tile_w=600, tile_h=600, pattern="grid")),
    ("draw_grout_lines",          dict(room_x=4000, room_y=-61000,
                                        room_w=2000, room_h=2000,
                                        tile_w=600, tile_h=600)),
    ("draw_border_strip",         dict(room_x=7000, room_y=-62000,
                                        room_w=3000, room_h=3000,
                                        border_w=150)),
    ("draw_tile_zones",           dict(room_x=0, room_y=-65000,
                                        room_w=5000, room_h=4000,
                                        zones=[{"x":0,"y":-65000,"w":2500,"h":4000,
                                                "pattern":"grid","tile_w":600,"tile_h":600},
                                               {"x":2500,"y":-65000,"w":2500,"h":4000,
                                                "pattern":"herringbone","tile_size":300}])),
]
